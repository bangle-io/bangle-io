...
export function RootHomePage() {
  ...
  const recentWsComp = workspaces.length > 0 && (
    <>
      <h3 className="mt-3 my-2 text-lg font-semibold my-2">
  ...
  return (
    <div
      className={cx(
        'bangle-editor-area primary-editor homepage',
        widescreen && 'widescreen',
      )}
    >
      <div class="bangle-editor-container">
        <div class="bangle-editor-inner-container">
          ...
          <ul className="list-inside list-disc my-2">
            ...
            <li className="text-lg sm:leading-10 font-medium mb-10 sm:mb-1">
              Press <kbd>{keybindings.toggleFilePalette.displayValue}</kbd> for
              File Palette
            </li>
            <li className="text-lg sm:leading-10 font-medium mb-10 sm:mb-1">
              Press <kbd>{keybindings.toggleCommandPalette.displayValue}</kbd>{' '}
              for Command Palette
            </li>
          </ul>
          {!recentWsComp && (
