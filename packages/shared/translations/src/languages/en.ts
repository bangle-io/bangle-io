  ...
  app: {
    ...
    dialogs: {
      ...
      createWorkspace: {
        ...
        serverFsTitle: 'Server Filesystem',
        serverFsDescription: 'Save workspace data on the server filesystem',
        serverFsPathLabel: 'Server Folder Path',
        serverFsPathPlaceholder: '/mnt/workspace-a/notes',
        serverFsPathRequired: 'Server folder is required',
        errorTitle: 'Error',
        ...
        attachmentSettingsTitle: 'Attachment Settings',
        attachmentModeLabel: 'Attachment path mode',
        attachmentModeRelative: 'Relative',
        attachmentModeRoot: 'Workspace Root',
        attachmentDirectoryLabel: 'Attachment folder',
        attachmentFilePrefixLabel: 'Pasted file name prefix',
        attachmentDirectoryRequired: 'Attachment folder is required',
        attachmentFilePrefixRequired: 'Attachment file name prefix is required',
      },
      allFiles: {
        title: 'All Files',
