  ...
  app: {
    ...
    editor: {
      ...
      slashCommand: {
        ...
        escapeToDismiss: 'Escape zum Schließen',
        paragraph: 'Absatz',
        heading: ({ level }: { level: number }) => `Überschrift ${level}`,
        codeBlock: 'Codeblock',
        table: 'Tabelle',
        date: 'Datum',
      ...
      datePicker: {
        hintSelect: 'Klicke auf einen Tag zum Einfügen',
        hintDismiss: 'Escape zum Schließen',
      },
      tableMenu: {
