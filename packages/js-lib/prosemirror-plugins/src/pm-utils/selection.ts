import type { Node as PMNode, ResolvedPos } from '@prosekit/pm/model';
...
export const findParentNode =
  ...
  ({ $from, $to }: Selection, validateSameParent = false): FindResult => {
...
export const findSelectedNodeOfType =
  (nodeType: NodeTypeParam) =>
  (selection: Selection): FindResult | undefined => {
