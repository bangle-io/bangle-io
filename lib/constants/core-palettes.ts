export const CORE_PALETTES_TOGGLE_ACTION_PALETTE =
  'action::bangle-io-core-palettes:TOGGLE_ACTION_PALETTE';

export const CORE_PALETTES_TOGGLE_WORKSPACE_PALETTE =
  'action::bangle-io-core-palettes:TOGGLE_WORKSPACE_PALETTE';

export const CORE_PALETTES_TOGGLE_NOTES_PALETTE =
  'action::bangle-io-core-palettes:TOGGLE_NOTES_PALETTE';

export enum CorePalette {
