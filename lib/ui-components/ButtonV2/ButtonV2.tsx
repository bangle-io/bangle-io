...
> = {
  [ButtonVariant.Solid]: {
    [Tone.Caution]: {
      ...
      hoverColor: vars.color.caution.btnColor,
    ...
    [Tone.Critical]: {
      ...
      hoverColor: vars.color.critical.btnColor,
    ...
    [Tone.Neutral]: {
      ...
      hoverColor: vars.color.neutral.btnColor,
    ...
    [Tone.Positive]: {
      ...
      hoverColor: vars.color.positive.btnColor,
    ...
    [Tone.Promote]: {
      ...
      hoverColor: vars.color.promote.btnColor,
  ...
  [ButtonVariant.Soft]: {
    [Tone.Caution]: {
      ...
      hoverColor: vars.color.caution.btn,
      pressedBgColor: vars.color.neutral.borderDark,
      disabledBgColor: 'transparent',
      disabledColor: vars.color.neutral.textDisabled,
    },
    [Tone.Critical]: {
      ...
      buttonBgColor: vars.color.neutral.borderLight,
      hoverBgColor: vars.color.neutral.border,
      hoverColor: vars.color.critical.btn,
      pressedBgColor: vars.color.neutral.borderDark,
      disabledBgColor: 'transparent',
      disabledColor: vars.color.neutral.textDisabled,
    },
    ...
    [Tone.Positive]: {
      ...
      buttonBgColor: vars.color.neutral.borderLight,
      hoverBgColor: vars.color.neutral.border,
      hoverColor: vars.color.positive.btn,
      pressedBgColor: vars.color.neutral.borderDark,
      disabledBgColor: 'transparent',
      disabledColor: vars.color.neutral.textDisabled,
    },
    [Tone.Promote]: {
      ...
      buttonBgColor: vars.color.neutral.borderLight,
      hoverBgColor: vars.color.neutral.border,
      hoverColor: vars.color.promote.btn,
      pressedBgColor: vars.color.neutral.borderDark,
      disabledBgColor: 'transparent',
      disabledColor: vars.color.neutral.textDisabled,
    },
